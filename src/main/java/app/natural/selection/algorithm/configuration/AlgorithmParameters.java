...
public class AlgorithmParameters {
    ...
    private final Integer foodFrequencyTicks;
    ...
    public AlgorithmParameters(Integer canvasHeight, Integer canvasWidth) {
        ...
        this.foodFrequencyTicks = DEFAULT_FOOD_FREQUENCY_TICKS;
    ...
    public Integer getFoodFrequencyTicks() {
        return foodFrequencyTicks;
    }
    ...
    public void decreaseTickPerSecond() {
        if (this.tickPerSecond >= 2) {
